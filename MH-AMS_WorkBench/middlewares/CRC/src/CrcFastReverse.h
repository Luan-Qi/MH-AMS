#ifndef __CRC_FAST_REVERSE__
#define __CRC_FAST_REVERSE__
//
...
//[[deprecated("Use reverse8bits() instead")]]
uint8_t reverse8(uint8_t in);
//[[deprecated("Use reverse12bits() instead")]]
uint16_t reverse16(uint16_t in);
//[[deprecated("Use reverse16bits() instead")]]
uint16_t reverse12(uint16_t in);
//[[deprecated("Use reverse32bits() instead")]]
uint32_t reverse32(uint32_t in);
//[[deprecated("Use reverse64bits() instead")]]
